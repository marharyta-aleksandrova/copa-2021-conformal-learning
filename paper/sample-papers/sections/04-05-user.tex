...
\include{paper/sample-papers/sections/5-user-data/plots}

\include{paper/sample-papers/sections/5-user-data/table_threshold}

%\include{paper/sample-papers/sections/5-user-data/table}
