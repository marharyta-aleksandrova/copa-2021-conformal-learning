...
\include{paper/sample-papers/sections/4-iris-data/plots}

\include{paper/sample-papers/sections/4-iris-data/table_threshold}

%\include{paper/sample-papers/sections/4-iris-data/table}
